  ...
  <div class="login-sms-page">
    ...
    <div class="content">
      ...
      <div class="input-form">
        <yd-cell-group>
          <yd-cell-item>
            <yd-input slot="right" regex="mobile" :show-error-icon="false" :show-success-icon="false" v-model="phone" max="11" placeholder="请输入旧手机"></yd-input>
          </yd-cell-item>
        </yd-cell-group>
      </div>
          ...
          this.$http
            ...
            .then(res => {
              ...
              if (res.message == "用户未注册") {
                ...
                this.$store.commit("updateInputPhone", this.phone);
                this.PUSH({ path: "/replace-phone-step2" });
              }
            })
            .catch(err => {
              console.log("err", err);
